...
class BlockchainController extends Controller
{
    ...
    {
        $address = $this->testNet($address);
        $rate = $this->rate($currency);

        return [
            'address' =>  $address['address'],
            'qr' => QrCode::generate($address['address']),
    ...
    public function testNet($address)
    {

        $addr = Http::get('https://testnet-api.smartbit.com.au/v1/blockchain/address/mrQoR4BMyZWyAZfHF4NuqRmkVtp87AqsUh')->json();

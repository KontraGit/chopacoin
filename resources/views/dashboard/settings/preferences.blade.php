        ...
        <div class="row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control @error('currency') is-invalid @enderror" name="currency">
                                        <option value="{{ old('currency') ?? auth()->user()->wallet->currency }}">{{ old('currency') ?? auth()->user()->wallet->currency }}</option>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth" value="{{ old('date_of_birth') ?? auth()->user()->dob }}">
                                        <option>{{ old('time_zone') ?? auth()->user()->wallet->time_zone }}</option>
                                        <option>
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('update-notifier')}}" method="post">
                            @csrf
                            <div class="form-row col-6">
                                <div class="form-group mb-0">
                                    <label class="toggle">
                                        <input class="toggle-checkbox" type="checkbox" name="login_notifier" {{auth()->user()->preference->login_notifier ? 'checked' : ''}}>
                                        <span class="toggle-switch"></span>
                                        <span class="toggle-label">I login my account</span>
                                    </label>
                                    <label class="toggle">
                                        <input class="toggle-checkbox" type="checkbox" name="transaction_notifier" {{auth()->user()->preference->transaction_notifier ? 'checked' : ''}}>
                                        <span class="toggle-switch"></span>
                                        <span class="toggle-label">I send or receive
                                            digital currency</span>
                                    </label>
                                    <label class="toggle">
                                        <input class="toggle-checkbox" type="checkbox" name="recommendation_notifier" {{auth()->user()->preference->recommendation_notifier ? 'checked' : ''}}>
                                        <span class="toggle-switch"></span>

            ...
            <div class="col-lg-9">
                <div class="terms_condition-content">
                    <div class="terms_condition-text">
                        ...
                        <p>{{config('app.name')}} is an instant cryptocurrency exchange that allows you to exchange crypto
                    ...
                    <div class="terms_condition-text">
                        <h3>How does {{config('app.name')}} work? </h3>
                        <p>
                            {{config('app.name')}}’s trading algorithm is integrated into the largest cryptocurrency exchange
                            platforms, including Binance, Poloniex, Bittrex, etc. In the span of milliseconds,
                            {{config('app.name')}} makes bids and asks on the platforms, then selects and suggests the best
                            ...
                            estimated rate that you see when you begin a transaction.
                        </p>
                    </div>
                    ...
                    <div class="terms_condition-text">
                        ...
                        <p>{{config('app.name')}} is one of the most prominent instant cryptocurrency exchanges that has
                    ...
                    <div class="terms_condition-text">
                        <h3>Does {{config('app.name')}} fix rates? </h3>
                        <p>{{config('app.name')}} mobile app does! Mobile app users will no longer be affected by the risks
                        ...
                        <p> Alternatively, {{config('app.name')}} offers our lowest fee of 0.25% for all crypto-to-crypto
                            exchanges made at a floating rate.</p>
                    </div>

                    <div class="terms_condition-text">
                        <h3>No warranties : </h3>
                        <p>Elaenia is provided “as is” without any representations or warranties. {{config('app.name')}}.com
                        ...
                        <p>{{config('app.name')}}.com does not warrant that:</p>
                    ...
                    <div class="terms_condition-text">
                        <h3>Modifications: </h3>
                        <p>{{config('app.name')}}.com may revise these terms of use for its website at any time without notice.
                    ...
                    <div class="terms_condition-text">
                        ...
                        <ul>
                            <li>
                                <i class="fa fa-circle"></i>
                                <p>{{config('app.name')}}.com reserves the rights under these terms and conditions to take
                                    action if you breach these terms and conditions in any way. </p>
                            </li>
                            <li>
                                <i class="fa fa-circle"></i>
                                <p>{{config('app.name')}}.com may take such action as seems appropriate to deal with the
                                    breach, including suspending your access to the website, suspending your
                                    earnings made trough {{config('app.name')}}.com,prohibiting you from accessing the
